...
_ **Hiệu suất:** Nhanh gấp 3 lần PostgreSQL và 5 lần MySQL tiêu chuẩn.
_ **Độ tin cậy:** Tự động sao chép **6 bản sao** dữ liệu qua **3 Vùng sẵn sàng (AZ)**. \* **Tối ưu:** Chi phí chỉ bằng 1/10 so với các DB thương mại truyền thống.
<p align="center">
  <img src="./assets/rds_read-replicas.gif" width="500"/>
</p>
<p align="center"><i> Hình 1 : Cơ chế Read Replicas của Amazon RDS </i></p>
...
<p align="center"><i> Hình 2 : DynamoDB Global Tables - Cơ chế sao chép đa vùng (Multi-Region Replication) </i></p>
...
<p align="center"><i> Hình 3 : Cơ chế di chuyển cơ sở dữ liệu với AWS DMS </i></p>
---
