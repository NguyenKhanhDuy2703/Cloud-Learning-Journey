...
![Hình 1: Cơ chế Multi-AZ và Read Replicas của Amazon RDS](assets/rds_architecture.png)
...
![Hình 2: DynamoDB Global Tables - Cơ chế sao chép đa vùng Active-Active](assets/dynamodb_global_tables.png)
...
![Hình 3: Quy trình di chuyển cơ sở dữ liệu với AWS DMS](assets/dms_migration.png)
