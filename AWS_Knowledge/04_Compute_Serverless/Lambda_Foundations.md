...
<p align="center"><i> Hình 1 : Hiện tượng "cold start" trong AWS Lambda </i></p>
...
<p align="center"><i> Hình 1 : Vòng đời môi trường thực thi của AWS Lambda </i></p>
...
<p align="center"><i> Hình 1 : Kiến trúc hướng sự kiện (EDA) với AWS Lambda </i></p>
...
<p align="center"><i> Hình 2 : Cơ chế đồng bộ (Synchronous Invocation) của AWS Lambda </i></p>
...
<p align="center"><i> Hình 3 : Cơ chế bất đồng bộ (Asynchronous Invocation) của AWS Lambda </i></p>
...
<p align="center"><i> Hình 4 : So sánh cơ chế đồng bộ và bất đồng bộ của AWS Lambda </i></p>
...
<p align="center"><i> Hình 4 : Kiến trúc hướng sự kiện (EDA) với AWS Lambda </i></p>
...
<p align="center"><i> Hình 5 : Cơ chế IAM Execution Role của AWS Lambda </i></p>

## 5. Các dịch vụ đi kèm & Tính năng nâng cao

1. **IAM Execution Role:** Cấp quyền cho Lambda thực thi các tác vụ (như đọc S3, ghi CloudWatch).
2. **Amazon CloudWatch:** Dịch vụ mặc định để thu thập logs và giám sát hiệu suất.
