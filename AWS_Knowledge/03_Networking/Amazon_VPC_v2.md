...
<p align="center">
  <img src="./assets/Security_NACL_vs_SG.svg" width="700" alt="NACL vs Security Group"/>
  <br/>
  <i>Minh họa trực quan: Lớp phòng thủ Network ACL và Security Group trong VPC</i>
</p>
...
<p align="center">
  <img src="./assets/Multi_Tier_VPC_Architecture.svg" width="900" alt="Multi-Tier VPC Architecture"/>
  <br/>
  <i>Minh họa: Kiến trúc VPC 3-layer chuẩn Enterprise với thư viện Icon chuẩn của AWS</i>
</p>
